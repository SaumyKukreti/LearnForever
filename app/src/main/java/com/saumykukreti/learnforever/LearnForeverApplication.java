...
public class LearnForeverApplication extends Application {

    private static LearnForeverApplication instance;
    private JobManager jobManager;


    public LearnForeverApplication() {
        instance = this;
    }
    ...
    public static LearnForeverApplication getInstance() {
        return instance;
    }
}
